...
public class CustomerDaoJdbcTemplateImpl implements CustomerDao {
    ...
    private static String CREATE_CUSTOMER_SQL = "CREATE TABLE CUSTOMER (CUSTOMER_ID VARCHAR(120), COMPANY_NAME VARCHAR(120), EMAIL VARCHAR(80), TELEPHONE VARCHAR(20), NOTES VARCHAR(255), PRIMARY KEY(CUSTOMER_ID))";
    private static String CREATE_PHONECALL_SQL = "CREATE TABLE PHONECALL (PHONECALL_ID integer generated by default as identity (start with 1), CUSTOMER_ID VARCHAR(255), TIME_AND_DATE DATE, NOTES VARCHAR(255))";
